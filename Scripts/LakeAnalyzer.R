### Script to load in and format catwalk data for use in Lake Analyzer in Matlab
...
########
# Pull catwalk data from EDI - updated from staging environment on 2 Nov 2021
...
catwalk_all <- read.csv("./Data/Catwalk_EDI_2018-2021.csv", header=T) %>%
...
ggplot(thermo_depth,mapping=aes(x=datetime,y=-thermo.depth)) +
  geom_line()+
  xlim(as.POSIXct("2020-04-01"), as.POSIXct("2021-05-01"))
